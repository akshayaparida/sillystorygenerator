...
function result() {
  ...
  if (document.getElementById("uk").checked) {
    ...
    const weightInStones = Math.round(weightInPounds * 0.071429);
    const temperatureInCentigrade = Math.round(
      (temperatureInFahrenheit - 32) * (5 / 9)
    );

    newStory = newStory
      .replaceAll("94 fahrenheit", temperatureInCentigrade + " centigrade")
      .replaceAll("300 pounds", weightInStones + " stone");
  }
